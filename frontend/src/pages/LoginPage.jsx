...
const T = {
  bg: "#CFF4F7", surface: "#ffffff", border: "rgba(43,177,168,0.18)",
  borderFocus: "rgba(43,177,168,0.55)", accent: "#2BB1A8", accentEnd: "#1d9e96",
  accentLight: "#e8fafb", teal: "#2BB1A8", red: "#e11d48", text: "#0A2A41",
  muted: "#3d6878", dim: "#7aacba", inputBg: "#f0fbfc", navy: "#0A2A41",
  paleAqua: "#CFF4F7", lightCyan: "#F2FBFF",
};
        ...
        <div style={{ width: "100%", maxWidth: 400, animation: "fadeUp 0.6s ease" }}>
          <div style={{ marginBottom: 28 }}>
            <div style={{
              ...
              background: rc.bg, border: `1px solid ${T.accent}30`,
