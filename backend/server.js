...
const certExamRoutes    = require('./routes/certExam');    // ← ADD
const certReportRoutes  = require('./routes/certReport'); 
...
app.use('/api/cert-exam',   certExamRoutes);    // ← ADD
app.use('/api/cert-report', certReportRoutes); 
